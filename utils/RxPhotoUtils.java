...
import static com.lanzhong.insuranceclaim.utils.RxFileUtils.getDataColumn;
import static com.lanzhong.insuranceclaim.utils.RxFileUtils.isDownloadsDocument;
import static com.lanzhong.insuranceclaim.utils.RxFileUtils.isExternalStorageDocument;
import static com.lanzhong.insuranceclaim.utils.RxFileUtils.isGooglePhotosUri;
import static com.lanzhong.insuranceclaim.utils.RxFileUtils.isMediaDocument;
...
public class RxPhotoUtils {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            RxToast.showToastShort("请先获取写入SDCard权限");
        } else {
